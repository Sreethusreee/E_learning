...
urlpatterns = [
    ...
    path('addtocart/<int:id>',studentView.AddToCart.as_view(),name="add_to_cart"),
    path('cart/list',studentView.ViewCart.as_view(),name="cart_list"),
    path('delete/<int:id>',studentView.DeleteCart.as_view(),name="cart_delete"),
    path('checkout',studentView.ChekoutView.as_view(),name="checkout_view"),
    path('checkout',studentView.ChekoutView.as_view(),name="checkout_view"),
